...
ONS_ROOT="${ONS_ROOT:-$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)}"
RUN_ROOT="${RUN_ROOT:-$ONS_ROOT/runs}"
LOG_ROOT="${LOG_ROOT:-$ONS_ROOT/logs}"
REPORT_ROOT="${REPORT_ROOT:-$ONS_ROOT/reports}"
CONFIG_FILE="${CONFIG_FILE:-$ONS_ROOT/conf/standby.env}"
